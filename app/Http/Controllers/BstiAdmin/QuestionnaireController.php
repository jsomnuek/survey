...
namespace App\Http\Controllers\BstiAdmin;
...
class QuestionnaireController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('bsti_admin.questionnaire.index', [
            'users' => $users,
    ...
    public function store(Request $request)
    {
        ...
        // create log activity
        LogActivity::addToLog("Bsti Admin Upload file : log_comment_lab : $LogCommentLabFile->log_comment_lab_id successfully.");
    ...
    public function show($id)
    {
        ...
        return view('bsti_admin.questionnaire.show', [
            'user' => $user,
    ...
    public function send($id)
    {
        ...
        return view('bsti_admin.questionnaire.send', [
            'user' => $user,
            'labJuly' => $labJuly,
            'labAugust' => $labAugust,
            'labSeptember' => $labSeptember,
    ...
    public function update(Request $request, $id)
    {
        ...
        if($survey_status_id == 2) {
            ...
            // create log activity
            LogActivity::addToLog("Bsti Admin Approve Lab : $lab->id : $lab->lab_code successfully.");

            return redirect()->route('bstiadmin-questionnaire.show', $lab->user_id);
        }
        ...
        if($survey_status_id == 5) {
            ...
            // create log activity
            LogActivity::addToLog("Bsti Admin Reject Lab : $lab->id : $lab->lab_code successfully.");
