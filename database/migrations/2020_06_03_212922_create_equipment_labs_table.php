...
class CreateEquipmentLabsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('equipment_labs', function (Blueprint $table) {
            ...
            $table->string('equipment_calibration_by', 255)->nullable()->comment('การสอบเทียบเครื่องมือโดย');//3.16.1การสอบเทียบเครื่องมือโดย
            $table->integer('equipment_calibration_year')->nullable()->comment('การสอบเทียบเครื่องมือปี');//3.16.2การสอบเทียบเครื่องมือปี
            ...
            $table->string('equipment_admin_name',255)->nullable()->comment('ผู้ดูแลเครื่องมือชื่อ');//3.19.1ผู้ดูแลเครื่องมือชื่อ
            ...
            $table->integer('equipment_manuals_id')->nullable()->comment('คู่มือเครื่องมือ');//3.20คู่มือเครื่องมือ
