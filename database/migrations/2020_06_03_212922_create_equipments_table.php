...
class CreateEquipmentsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('equipments', function (Blueprint $table) {
            ...
            $table->string('equipment_code')->nullable()->comment('รหัสเครื่องมือ AABCC-MNN-RRRSS');          //3.1 รหัสเครื่องมือ AABCC-MNN-RRRSS
            $table->unsignedBigInteger('science_tool_id')->nullable()->comment('ชื่อเครื่องมือEN');               //3.2.1 ชื่อเครื่องมือEN FK with other Table
            $table->string('science_tool_other_name', 255)->nullable()->comment('ชื่อเต็มเครื่องมือ EN อื่นๆ');        //3.2.2 ชื่อเต็มเครื่องมือEN
            $table->string('science_tool_other_abbr', 255)->nullable()->comment('ชื่อย่อเครื่องมือ EN อื่นๆ');        //3.2.3 ชื่อย่อเครื่องมือEN
            ...
            $table->string('equipment_number', 255)->nullable()->comment('รหัสเครื่องมือในหน่วยงาน');          //3.6รหัสเครื่องมือในหน่วยงาน
            ...
            $table->string('major_technology_other', 255)->nullable()->comment('สาขาเทคโนเครื่องมืออื่นๆ ');   //3.10.1สาขาเทคโนเครื่องมืออื่นๆ
            ...
            $table->string('equipment_image')->nullable()->comment('รูปเครื่องมือ');                              //3.14รูปเครื่องมือ
            $table->integer('equipment_calibration_id')->nullable()->comment('การสอบเทียบเครื่องมือ');         //3.15 การสอบเทียบเครื่องมือ ใช่-ไม่ใช่
            ...
            $table->string('equipment_admin_phone', 255)->nullable()->comment('ผู้ดูแลเครื่องมือเบอร์โทร');            //3.18.2ผู้ดูแลเครื่องมือเบอร์โทร
            $table->string('equipment_admin_email', 255)->nullable()->comment('ผู้ดูแลเครื่องมืออีเมล์');               //3.18.3ผู้ดูแลเครื่องมืออีเมล์
            $table->integer('equipment_manual_id')->nullable()->comment('คู่มือเครื่องมือ');                     //3.19.1คู่มือเครื่องมือ มี-ไม่มี
            $table->string('equipment_manual_name', 255)->nullable()->comment('ชื่อคู่มือเครื่องมือ');                   //3.19.2ชื่อคู่มือเครื่องมือ
            $table->string('equipment_manual_location', 255)->nullable()->comment('ที่อยู่คู่มือเครื่องมือ');          //3.19.3ที่อยู่คู่มือเครื่องมือ
            $table->integer('equipment_rent_id')->nullable()->comment('เช่าใช้เครื่องมือ');                      //3.20.1เช่าใช้เครื่องมือใช่-ไม่ใช่
