...
class CreateProductLabsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('product_labs', function (Blueprint $table) {
            ...
            $table->string('product_lab_test_control_other', 255)->nullable()->comment('อื่นๆการควบคุมคุณภาพผลการทดสอบ');//4.14การควบคุมคุณภาพผลการทดสอบ 
        ...
        // Schema::create('product_labs_calibrating', function (Blueprint $table) {
        //     $table->bigIncrements('id');
