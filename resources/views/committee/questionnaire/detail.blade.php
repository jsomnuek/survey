...
@section('page')
Committee Questionnaire Detail
@endsection
			...
			<div class="card-body">
				<blockquote class="mx-0 mt-0 bg-light">
                    ...
                    <div class="d-flex flex-row justify-content-start">
						...
						<span class="mr-2">
							<a href="/committee-questionnaire/{{$lab->user_id}}" class="btn btn-secondary btn-xs">
...
<div class="modal fade" id="modal-approve" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form action="/committee-questionnaire/{{ $lab->id }}" method="POST" role="form">
				@csrf
				@method('PUT')
