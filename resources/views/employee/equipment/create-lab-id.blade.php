		...
		<div class="col-md-12">
            ...
            <div class="card card-primary">
				<div class="card-header">
					<h3 class="card-title"><i class="far fa-edit"></i> เพิ่มข้อมูลเครื่องมือวิทยาศาสตร์ :</h3>
				</div>
				<!-- /.card-header -->
				<!-- form start -->
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<select class="form-control custom-select select2 @error('science_tool_id') is-invalid @enderror" data-placeholder="-- โปรดเลือก --" style="width: 100%;" name="science_tool_id" id="science_tool_id" required>
                                        ...
                                        <option value="{{ $item->id }}" {{ ( old('science_tool_id') == $item->id) ? 'selected' : '' }}>
								...
								<div class="form-group d-none" id="display_science_tool_other_name">
									...
									<input class="form-control @error('science_tool_other_name') is-invalid @enderror" type="text" name="science_tool_other_name" id="science_tool_other_name" placeholder="" value="{{ old('science_tool_other_name') }}">
							...
							{{-- <div class="col-md-6">
								<div class="form-group d-none" id="display_science_tool_other_abbr">
									...
									<input class="form-control @error('science_tool_other_abbr') is-invalid @enderror" type="text" name="science_tool_other_abbr" id="science_tool_other_abbr" placeholder="" value="{{ old('science_tool_other_abbr') }}">
							...
							<div class="col-md-6">
								...
								<div class="form-group d-none" id="display_major_technology_other">
									<label for="major_technology_other">
										กรณีเลือกอื่นๆ โปรดระบุ :<span><sup class="text-danger"> *</sup>
									</label>
									<input class="form-control" type="text" name="major_technology_other" id="major_technology_other" placeholder="" value="{{ old('major_technology_other') }}">
								</div>
							</div>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<select class="form-control custom-select select2 @error('equipment_usage_id') is-invalid @enderror" data-placeholder="-- โปรดเลือก --" style="width: 100%;" name="equipment_usage_id" id="equipment_usage_id" required>
										...
										<option value="{{$item->id}}" {{ old('equipment_usage_id') ==  $item->id ? 'selected' : '' }}>
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" class="form-control @error('equipment_admin_name') is-invalid @enderror" name="equipment_admin_name" id="equipment_admin_name" value="{{ old('equipment_admin_name') }}" required>
							...
							<div class="col-md-6">
								...
								<div class="form-group" id="display_equipment_manual_name">
									...
									<input type="text" class="form-control" name="equipment_manual_name" id="equipment_manual_name" placeholder="" value="{{ old('equipment_manual_name') }}">
								</div>
								<div class="form-group" id="display_equipment_manual_locate">
									...
									<input type="text" class="form-control" name="equipment_manual_location" id="equipment_manual_location" placeholder="" value="{{ old('equipment_manual_location') }}">
								</div>
							</div>
							...
							<div class="col-md-6">
								...
								<div class="form-group" id="display_equipment_rent_fee">
									...
									<input type="text" class="form-control" name="equipment_rent_fee" id="equipment_rent_fee" value="{{ old('equipment_rent_fee') }}">
								</div>
