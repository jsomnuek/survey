                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="org_name" class="form-control @error('org_name') is-invalid @enderror" id="org_name" placeholder="" value="{{ old('org_name') }}">
                                    @error('org_name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control custom-select select2 @error('organisation_type_id') is-invalid @enderror" data-placeholder="-- โปรดเลือก --" style="width: 100%;" name="organisation_type_id" id="organisation_type_id" data-value="{{ old('organisation_type_id') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control custom-select select2 @error('business_type_id') is-invalid @enderror" data-placeholder="-- โปรดเลือก --" style="width: 100%;" name="business_type_id" id="business_type_id" data-value="{{ old('business_type_id') }}">
                                        <option value="" selected disabled="disabled">disabled</option>
                                ...
                                <div class="form-group row d-none" id="">
                                    <label for="business_type_other" class="col-md-2 col-form-label">โปรดระบุ :<span><sup class="text-danger"> *</sup></span></label>
                                    <div class="col-md-10">
