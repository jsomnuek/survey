                    ...
                    <div class="card-body">
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="product_lab_standard" class="form-control  @error('product_lab_standard') is-invalid @enderror" id="product_lab_standard" placeholder="" value="{{ old('product_lab_standard')}}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="product_lab_test_name" class="form-control @error('product_lab_test_name') is-invalid @enderror" id="product_lab_test_name" placeholder="" value="{{ old('product_lab_test_name')}}" >
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-2 custom-control custom-radio">
                                <input class="custom-control-input" type="radio" id="product_lab_test_method1" name="product_lab_test_method" value="1" {{ old('product_lab_test_method') ==  1? 'checked' : ''}}>
                                <label class="custom-control-label" for="product_lab_test_method1">Inhoused Method</label>
                            </div>
                            <div class="col-md-2 custom-control custom-radio">
                                <input class="custom-control-input" type="radio" id="product_lab_test_method2" name="product_lab_test_method" value="2" {{ old('product_lab_test_method') ==  2? 'checked' : ''}}>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="product_lab_test_duration" class="form-control " id="" placeholder="" value="{{ old('product_lab_test_duration')}}">
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col-md-6">
                                <label for="">4.10 ค่าธรรมเนียมการทดสอบ/สอบเทียบ </label>
                                <input type="text" name="product_lab_test_fee" class="form-control " id="" placeholder="ระบุค่าธรรมเนียมการทดสอบ/สอบเทียบ (หน่วยบาท)" value="{{ old('product_lab_test_fee')}}">
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" id="product_lab_test_control1" name="product_lab_test_control" value="{{ old('product_lab_test_control')}}">
                                        <label for="product_lab_test_control1" class="custom-control-label">ไม่มี</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" id="product_lab_test_control2" name="product_lab_test_control" value="{{ old('product_lab_test_control')}}">
                                        <label for="product_lab_test_control2" class="custom-control-label">มีการใช้ Spiked Sample</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" id="product_lab_test_control3" name="product_lab_test_control" value="{{ old('product_lab_test_control')}}">
                                    ...
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" id="product_lab_test_control4" name="product_lab_test_control" value="{{ old('product_lab_test_control')}}">
                                        <label for="product_lab_test_control4" class="custom-control-label">มีการวิเคราะห์ Regrant Blank ,Field Blank</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" id="product_lab_test_control5" name="product_lab_test_control" value="{{ old('product_lab_test_control')}}">
                                        <label for="product_lab_test_control5" class="custom-control-label">มีการทำซ้ำ</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" id="product_lab_test_control6" name="product_lab_test_control" value="{{ old('product_lab_test_control')}}">
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <div class="custom-control custom-radio">
                                    <input class="custom-control-input" type="radio" id="proficiency_testing1" name="proficiency_testing" value="{{ old('proficiency_testing')}}">
                                    <label for="proficiency_testing1" class="custom-control-label">ไม่มี</label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <input class="custom-control-input" type="radio" id="proficiency_testing2" name="proficiency_testing" value="{{ old('proficiency_testing')}}">
