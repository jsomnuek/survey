                    ...
                    <div class="card-body">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-2 custom-control custom-radio">
                                <input class="custom-control-input @error('testing_calibrating_type_id') is-invalid @enderror" type="radio" id="product_lab_test_method1" name="product_lab_test_method" value="1" {{ old('product_lab_test_method') ==  1? 'checked' : ''}}>
                                <label class="custom-control-label" for="product_lab_test_method1">Inhoused Method</label>
                            </div>
                            <div class="col-md-2 custom-control custom-radio"  >
                                <input class="custom-control-input @error('testing_calibrating_type_id') is-invalid @enderror" type="radio" id="product_lab_test_method2" name="product_lab_test_method" value="2" {{ old('product_lab_test_method') ==  2? 'checked' : ''}}>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" id="product_lab_test_control1" name="product_lab_test_control" value='1' {{ old('product_lab_test_control') == 1 ? 'checked' : ''}}>
                                        <label for="product_lab_test_control1" class="custom-control-label">ไม่มี</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" id="product_lab_test_control2" name="product_lab_test_control" value='2' {{ old('product_lab_test_control') == 2 ? 'checked' : ''}}>
                                        <label for="product_lab_test_control2" class="custom-control-label">มีการใช้ Spiked Sample</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" id="product_lab_test_control3" name="product_lab_test_control" value='3' {{ old('product_lab_test_control') == 3 ? 'checked' : ''}}>
                                    ...
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" id="product_lab_test_control4" name="product_lab_test_control" value='4' {{ old('product_lab_test_control') == 4 ? 'checked' : ''}}>
                                        <label for="product_lab_test_control4" class="custom-control-label">มีการวิเคราะห์ Regrant Blank ,Field Blank</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" id="product_lab_test_control5" name="product_lab_test_control" value='5' {{ old('product_lab_test_control') == 5 ? 'checked' : ''}}>
                                        <label for="product_lab_test_control5" class="custom-control-label">มีการทำซ้ำ</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input class="custom-control-input" type="radio" id="product_lab_test_control6" name="product_lab_test_control" value='6' {{ old('product_lab_test_control') == 6 ? 'checked' : ''}}>
